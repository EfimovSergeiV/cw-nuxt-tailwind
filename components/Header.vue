<template>
  ...
  <nav class="bg-white border-gray-200 dark:border-gray-600 dark:bg-gray-900">
    ...
    <transition name="fade">  
      <div v-if="openmenu" id="mega-menu-full-dropdown" :class="[openmenu ? 'text-gray-500' : 'hiddenw', 'absolute z-10 mt-1 bg-white border-gray-200 shadow-sm border-y dark:bg-gray-800 dark:border-gray-600']">
